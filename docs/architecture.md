...
- Configuring Skippy. TODO linkify
- Configuring Mod Score tasks. TODO linkify
...
- Creates and exposes the `slack` extension DSL. TODO linkify
...
- Configures the dependency analysis gradle plugin and `DependencyRake`. TODO linkify.
...
- Configures AndroidTest APK aggregation with Skippy support. TODO linkify.
...
- Application projects...
  ...
  - are configured with `PermissionChecks`. TODO linkify
